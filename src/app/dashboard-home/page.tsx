...
import { MessageCircle, BookOpen, Users, Search, ArrowRight, Sparkles, Zap, Mic } from "lucide-react"
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-16">
            ...
            >
              <Link href="/dictionary">
                <Card className="p-8 text-center hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm border-2 hover:border-teal-300 cursor-pointer group">
                  ...
                  <h4 className="text-lg font-medium text-gray-800">Search</h4>
                  <Badge variant="secondary" className="bg-green-100 text-green-700 mt-3">
                    <Zap className="w-3 h-3 mr-1" />
                    Active
                  </Badge>
            ...
            >
              ...
              <Card className="p-8 text-center hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm border-2 hover:border-purple-300 cursor-pointer group opacity-75">
                ...
                <h4 className="text-lg font-medium text-gray-600">Network</h4>
