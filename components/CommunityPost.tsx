...
import { UserIcon, Clock, Heart, ThumbsUp, MessageCircle, Flag, Play, Pause, Send, Mic } from "lucide-react"
...
export default function CommunityPost({ post, onReply, onReact }: CommunityPostProps) {
